...
terminal, or the page slot on a phone) and what closing it leaves behind, and
the two ``flow*_check`` harnesses on the flow view — one on the track a
workflow becomes, one on the page those tracks are drawn into. This wrapper is
